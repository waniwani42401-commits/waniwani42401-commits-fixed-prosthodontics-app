const CACHE='cb-fixed-v1.1.0';
const CORE=['./', './index.html', './app.js', './data.js', './styles.css', './manifest.webmanifest', './icons/icon-192.png', './icons/icon-512.png', './icons/apple-touch-icon.png'];
